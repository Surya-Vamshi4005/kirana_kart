...
const Header = () => {
  ...
  return (
    <header className="fixed backdrop-blur-md z-50 inset-x-0 top-0 flex items-center justify-between px-12 md:px-20 py-6">
        <NavLink to={"/"} className="flex items-center justity-center gap-8 ">
                <img src={Logo} className="w-14 -mx-6 " alt="" />
            <p className="font-bold text-2xl px-4">Kirana Kart</p>
        </NavLink>
        ...
        <nav className="flex items-center justify-center gap-8">
            ...
            <motion.div {...buttonClcik} onClick={() => dispatch(setCartOn())}
            ...
            <>
                    ...
                    {isMenu && (
                         <motion.div
                         {...slideTop}
                         onMouseLeave={() => setIsMenu(false)} className="px-6 py-4 w-48 bg-lightOverlay
            ...
            <>
                ...
                <NavLink to = {"/login"}>
                    ...
                    <motion.button {...buttonClcik} className="px-4 py-2 rounded-md shadow-md bg-lightOverlay border border-red-300 cursor-pointer">
