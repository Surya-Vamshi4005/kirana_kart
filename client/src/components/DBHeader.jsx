...
import { BsFillBellFill, MdLogout, MdSearch } from "../assets/icons"
import { BsToggles2 } from "../assets/icons"
    ...
    <div className="w-full flex items-center justify-between gap-3">
        ...
        Welcome to Kirana_kart
         {user?.name && (
            ...
            <div className=" flex items-center justfy-center gap-4 ">
                <div className= "flex items-center justify-center gap-3 px-4 py-2 bg-lightOverlay backdrop-blur-md rounded-md shadow-md">
                    ...
                    <input tye="text" placeholder="Search Here..." 
                    className="border-none utline-none bg-transparent w-32 text-base font-semibold text-textColor" />
